...
task :fetch do
  download("https://github.com/espace/tinymce/releases/download/#{TinyMCE::Rails::TINYMCE_VERSION}-turbolinks/tinymce.zip", "tinymce.zip")
  download("https://github.com/espace/tinymce/releases/download/#{TinyMCE::Rails::TINYMCE_VERSION}-turbolinks/tinymce_dev.zip", "tinymce.dev.zip")
end
